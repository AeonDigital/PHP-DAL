...
class Schema implements iSchema
{
            ...
            foreach ($columnNames as $cName) {
                ...
                if ($oColumn->isReference() === false) {
                    ...
                    // Adiciona instrução para colunas comuns
                        ...
                        // Efetua tratamento para casos "Real".
                        $stType = $oColumn->getType();
                        ...
                        if (\mb_str_starts_with($oColumn->getType(), "Real") === true) {
                            ...
                            $parts = \array_map(
                                ...
                                \explode(
                                    ",",
                                    \str_replace(["Real(", ")"], "", $oColumn->getType())
                                )
                            );
                        ...
                        $useType    = \str_replace("AeonDigital\\SimpleType\\st", "", $stType);
     ...
     *
     * @param       ?int $precision
     *              Usado para campos "Real".
     *              Indica o tamanho total de dígitos para um número "Real".
     *
     * @param       ?int $scale
     *              Usado para campos "Real".
     *              Indica quantos dos dígitos totais serão usados para a parte fracionaria
     *              do número.
     *
     * @return      string
     */
